...
var finalEmail;
class afficher_detaille_colislivrer extends StatefulWidget {
  const afficher_detaille_colislivrer({Key? key});

  @override
  State<afficher_detaille_colislivrer> createState() => _TestState();
}

class _TestState extends State<afficher_detaille_colislivrer> {
  ...
  Future<void> fetchData() async {
    final response = await http.post(Uri.parse('http://20.20.1.245:82/api_store/aff_detaille_colis.php'), body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(drawer: NavBare(),
      appBar: AppBar(
...
void main() {
  runApp(MaterialApp(
    home: afficher_detaille_colislivrer(),
  ));
}
